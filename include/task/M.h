...
namespace task
{
    ...
    public:
        ...
        MatrixXd ddt(const VectorXd& q, const VectorXd& dq) const;
        MatrixXd ddqdq(const VectorXd& q, const VectorXd& dq) const;

        MatrixXd operator()(const int bodyNumber, const VectorXd& q) const;
        MatrixXd ddt(const int bodyNumber, const VectorXd& q, const VectorXd& dq) const;
        MatrixXd ddqdq(const int bodyNumber, const VectorXd& q, const VectorXd& dq) const;

        VectorXd ddt(const VectorXd& q, const VectorXd& dq, const VectorXd& eta) const;
