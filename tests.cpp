...
namespace PhiTimeDerivatives
{
    ...
    struct data_struct
    {
        ...
        data_struct(_input_ *i, task::Phi *P, _solution_ *s, double test_time) : input(i), Phi(P), solution(s)
        {
...
{
    /* note: works only for Tk = 1 in input.cpp */
...
TEST_LIST = {
    ...
    {"F_1_q",               task_tests::F_1_q::test},
    {"F_1_dq",              task_tests::F_1_dq::test},
    {"F_2_dq",              task_tests::F_2_dq::test},
    {"M_ddqdq",             task_tests::M_ddqdq::test},
    {"Phi_ddqddqlambda",    task_tests::Phi_ddqddqlambda::test},
    {"atTime",              test_atTime},
